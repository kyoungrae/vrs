                            ...
                            <div class="col-12 col-sm-1 col-lg">
                                ...
                                <table id="referenceTable" class="display responsive nowrap" style="width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="4">{{ isset($move) ? $move[1] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>좌석</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[2] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>화물</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[3] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>버스</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[4] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>특수</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[5] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>탱크</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[6] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>기관차</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[7] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>기계</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[8] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>트레일러</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[9] : 0 }}</td>
                                    </tr>
                                    <tr>
                                        <td><strong>오토바이</strong></td>
                                        <td colspan="4">{{ isset($move) ? $move[10] : 0 }}</td>
                                    </tr>
                                    </tfoot>
                                </table>
                            </div>
