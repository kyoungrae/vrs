...
<script>
    ...
    function exportToExcel() {
        ...
        $.ajax({
            type: "GET",
            url: vrsUrl("/api/report/archiveusers/@if(ISSET($curr_user)){{ $curr_user }}@else{{ "none" }}@endif/@if(ISSET($startDate)){{ $startDate }}@else{{ "none" }}@endif/@if(ISSET($endDate)){{ $endDate }}@else{{ "none" }}@endif"),
            success: function (data) {
                @if(ISSET($startDate))
                    $(".avtoteeverPreloader").fadeOut();
                $(".containerBody").fadeIn();
                window.location = vrsUrl("/api/report/archiveusers/@if(ISSET($curr_user)){{ $curr_user }}@else{{ "none" }}@endif/@if(ISSET($startDate)){{ $startDate }}@else{{ "none" }}@endif/@if(ISSET($endDate)){{ $endDate }}@else{{ "none" }}@endif");
                @else
                    $(".avtoteeverPreloader").fadeOut();
                $(".containerBody").fadeIn();
