                                        ...
                                        <div class="col-3">
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-8 col-md-12 col-sm-12">
                                                    <input id="last" name="lastName" type="text" value="{{ isset($lastName) ? $lastName : "" }}" class="form-control" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-8 col-md-12 col-sm-12">
                                                    <input id="first" name="firstName" type="text" value="{{ isset($firstName) ? $firstName : "" }}" class="form-control" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-3">
...
<script>
    ...
    function exportToExcel() {
        ...
        $.ajax({
            type: "GET",
            url: vrsUrl('/api/report/exportToExcelVehicleRefOld/')+register+"/"+lastName+"/"+firstName,
            success: function (data) {
                if(register != "none" || lastName != "none" || firstName != "none"){
                    window.location = "{{ url('/api/report/exportToExcelVehicleRefOld/') }}"+register+"/"+lastName+"/"+firstName;
    ...
    function checkFingerData(){
        ...
        if(is_export){
            ...
            var result = saveLog(2, request_type, register, req_type, req_name, desc, total, fingerDescription, {{ session()->get("auth")->id }}, '{{ \Carbon\Carbon::now()->format('Y-m-d H:i:s') }}');
        } else {
