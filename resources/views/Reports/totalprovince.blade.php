                ...
                <div class="row row-sm">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <h6 class="card-title">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    НИЙТ ТЭЭВРИЙН ХЭРЭГСЛИЙН СТАТИСТИК МЭДЭЭ
                                </div>
                            </div>
                        </h6>
                        <div class="row row-sm">
                            <div class="col-12 col-sm-1 col-lg">
                                ...
                                <table id="referenceTable" class="display responsive nowrap" style="width:100%;">
                                    ...
                                    @if(ISSET($datas_nas))
                                        ...
                                        @endforeach
                                    @endif
                                    @if(ISSET($datas_wheel))
                                        @foreach($datas_wheel as $data)
                                            <tr>
                                                <td>{{ $data[24] }}</td>
                                                <td>{{ $data[0] }}</td>
                                                <td>{{ $data[1] }}</td>
                                        ...
                                        @endforeach
                                    @endif
                                    @if(ISSET($datas_tulsh))
                                        @foreach($datas_tulsh as $data)
                                            <tr>
                                                <td>{{ $data[24] }}</td>
                                                <td>{{ $data[0] }}</td>
                                                <td>{{ $data[1] }}</td>
                                        ...
                                        @endforeach
                                    @endif
                                    @if(ISSET($datas_zoriulalt))
                                        @foreach($datas_zoriulalt as $data)
                                            <tr>
                                                <td>{{ $data[24] }}</td>
                                                <td>{{ $data[0] }}</td>
                                                <td>{{ $data[1] }}</td>
