            ...
            <div class="row row-sm">
                ...
                <div class="col-lg-9 col-md-12 col-sm-12">
                    ...
                    <div class="row row-sm">
                        ...
                        @endif
                            <form action="{{route('vehiclePlateRecover')}}" method="POST">
                                {{ csrf_field() }}
                                <div class="row row-sm">
                                    <div class="col-4">
                                    ...
                                    {{-- <div class="col-3"> --}}
                                        ...
                                        {{-- <div  class="row row-xs align-items-center mg-b-5">
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <label class="form-label mg-b-0 required-input">소유자 등록번호</label>
                                            </div>
                                            <div class="col-lg-8 col-md-8 col-sm-8">
                                                <input id="register" name="register"  required type="text" placeholder="소유자 등록번호"  value="" class="form-control" autocomplete="off">
                                            </div>
                                        </div> --}}
                                        {{-- <div class="row row-xs align-items-center mg-b-5">
                                ...
                                <div style="    padding: 0;" class="col-lg-6 col-md-6 col-sm-12" id="ntrDetail">
                                    ...
                                    <div class="col-8 align-items-center mg-b-5" id="orderRegNum" style="display: none">
                                        <div class="row row-xs">
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <label class="form-label mg-b-0 required-input">등록 번호</label>
                                        </div>
                                        <div class="col-lg-8 col-md-12 col-sm-12">
                                            <input id="customerRegister" name="customerRegister" oninput="wordUpperCase(this.value)"  
                                            style="display: block" placeholder="등록 번호"  type="hidden" readonly   value="" class="form-control"  autocomplete="off" autofocus required>
...
<script>
     ...
     var registerCheck="";
     if(data[0]['type_id'] != 1) {
        registerCheck= data[0]['register_no'].substring(0,7);
    
    }else{
        registerCheck= data[0]['register_no'];
    } 
         //   $("#orderRegNum").css("display", "block");
            $('#customerRegister').val(registerCheck);
                  $("#orderCabin").css("display", "block");
            $("#vehicleTableBody").html("");
                  
                  var html = '<table class="table table-bordered" id="vehicleTable">'+
                  '<tr>'+'<td colspan="2" style="text-align: center;font-weight: bold;">'+"제거 정보" +'</td>'+'</tr>'+
                  
                  '<tr >' +
                      ' <td > ' + '<strong> 제거된 번호 </strong>'+ ' </td>' +
                      ' <td > '  +data[0]['plate_no']+ ' </td>' +
                                      
                   ' </tr>'+
                   '<tr >' +
                      ' <td > ' + '<strong> 제거 번호 </strong>'+ ' </td>' +
                      ' <td > '  +data[0]['insert_plate_no']+ ' </td>' +
