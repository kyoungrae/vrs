                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>   
                                                    ...
                                                    <input id="customerRegnum" name="customerRegnum" style="display: block" placeholder="주문자 등록번호"  type="text"  class="form-control"  oninput="this.value = this.value.toUpperCase()"  required/>
