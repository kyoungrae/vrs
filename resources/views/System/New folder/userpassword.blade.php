                    ...
                    <form action="{{ route("password") }}" method="POST">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row row-xs align-items-center mg-b-5">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <label class="form-label mg-b-0 required-input">새 비밀번호</label>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                ...
                                <div class="row row-xs align-items-center mg-b-5">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <label class="form-label mg-b-0 required-input">새 비밀번호(давт)</label>
                                    </div>
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <input type="password" id="passwordcomfirm" name="passwordcomfirm" required class="form-control">
                                    </div>
                                </div>
                            </div>
                            <!--왼쪽 영역 끝-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-6 col-sm-6">
                                <button class="btn btn-primary btn-block">Солих</button>
                            </div>
                        </div>
                    </form>
                </div>
