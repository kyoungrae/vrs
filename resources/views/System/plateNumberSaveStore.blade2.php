...
<script>
     ...
     //console.log(data['last_name'] );
          ...
          $("#orderPlate").css("display", "none");
                ...
                $("#customerTable").css("display", "block"); 
                usePos =="Бүртгэлийн ахлах мэргэ년тэн" || usePos =="Бүртгэлийн ахлах мэргэ년тэн, дуудлага худалдаа хариуцсан"  ? $("#customerRegnum").prop("readonly", false) :   $("#customerRegnum").prop("readonly", false);
