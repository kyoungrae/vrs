                ...
                <div class="col-lg-9 col-md-6 col-sm-12">
                    ...
                    @if(ISSET($vehicle))
                        @if(ISSET($vehicle_count))
                            @if($vehicle_count > 1)
                                <div class="alert alert-outline-danger" role="alert">
                                    ...
                                    <h5>{{ $vehicle->plate_no }} 번호판 {{ $vehicle_count }} 차량 -д олгогдсон 입니다. Давхардлыг арилгасны дараа үйлчилгээ 해주세요!!!</h5>
                                </div>
                            @endif
                        @endif
                        ...
                        <div class="alert alert-outline-danger" role="alert">
                            ...
                            <h5>{{ $vehicle->plate_no }} 번호판тай 차량은 RFID TAG наалгаагүй 입니다 .</h5>
                        </div>
                    @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="row row-xs align-items-center mg-b-5">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <input type="text" id="number_id" name="number" value="{{ isset($vehicle) ? (isset($vehicle->plate_no) ? $vehicle->plate_no : "") : "" }}" class="form-control number text-uppercase" oninput="translate2MGL(this.value)" autocomplete="off" autofocus>
                                    </div>
                                </div>
                                <div class="row row-xs align-items-center mg-b-5">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
