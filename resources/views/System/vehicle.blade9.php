                ...
                <div class="row row-sm">
                    ...
                    <div class="col-lg-9 col-md-6 col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div id="headerButton" class="col-lg-6 col-md-6 col-sm-12 rightAlign">
                                    <a href="/report/form" target="_blank">
                                        <span class="headerButton"><i
                                                class="icon ion-ios-list-box headerButtonIcon"></i> 서식</span>
                                    </a>
                                    <a href="#printModal" data-toggle="modal" data-effect="effect-scale">
                                        <span id="btnPrint" class="headerButton"><i
                                                class="icon ion-ios-print headerButtonIcon"></i> 인쇄</span>
                                    </a>
                                    <a href="#printModalNEW" data-toggle="modal" data-effect="effect-scale">
                                        <span id="btnPrintNEW" class="headerButton"><i
                                                class="icon ion-ios-print headerButtonIcon"></i> 신규 인쇄</span>
                                    </a>
                                    <a onclick="submitForm()">
                                        <span class="headerButton"><i class="icon ion-ios-save headerButtonIcon"></i>
                                            저장</span>
                                    </a>
                                    <a onclick="cancel_selected_menu();">
                                        <span id="btnCancel" class="headerButton"><i
                                                class="icon ion-ios-exit headerButtonIcon"></i> 취소</span>
                                    </a>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="alert alert-outline-danger" role="alert">
                            ...
                            <h5>{{ $vehicle->plate_no }} 번호판 {{ $vehicle_count }} ТХ -д олгогдсон байна. Давхардлыг
                        ...
                        @if ( $Diagnostic != null && \Carbon\Carbon::parse($Diagnostic->dateagain)->format("Y-m-d") <=
                            ...
                            <div class="alert alert-outline-danger" role="alert">
                                ...
                                @if ($vehicle->purpose_id != 2 && $vehicle->purpose_id !=4 && $vehicle->purpose_id !=5
                                && $vehicle->purpose_id !=7 && $vehicle->purpose_id !=8)
                                <h5>수입 차량은 반드시 검사를 받아야 합니다.</h5>
                            ...
                            <div class="alert alert-outline-danger" role="alert">
                                ...
                                @if ( in_array(\Illuminate\Support\Str::substr($vehicle->plate_no, -3), ['MMA', 'ММА'],
                                true) || $vehicle->purpose_id == 2 || $vehicle->purpose_id ==4 || $vehicle->purpose_id
                            ...
                            @if($Diagnostic->dateagain != null &&
                            \Carbon\Carbon::parse($Diagnostic->dateagain)->format("Y-m-d") <= \Carbon\Carbon::now()->
                                format("Y-m-d"))
                                ...
                                <div class="alert alert-outline-danger" role="alert">
                                    ...
                                    @if ($vehicle->purpose_id != 2 && $vehicle->purpose_id !=4 && $vehicle->purpose_id
                                    !=5 && $vehicle->purpose_id !=7 && $vehicle->purpose_id !=8)
                                    <h5>차량의 재검사 기한이 지났습니다.</h5>
                                    @elseif ( in_array(\Illuminate\Support\Str::substr($vehicle->plate_no, -3), ['MMA',
                                    'ММА'], true) || $vehicle->purpose_id == 2 || $vehicle->purpose_id ==4 ||
                                    $vehicle->purpose_id ==5 || $vehicle->purpose_id ==7 || $vehicle->purpose_id ==8)
                                    <h5>차량이 검사에 참여하지 않았습니다. MNS 6278 기준을 초과한 경우 MMA를 부여합니다.</h5>
                                    @else
                                    <h5>해당 차량이 검사에 참여하지 않았습니다. MNS 6278 기준을 초과한 경우 MMA를 부여합니다.</h5>
                                    @endif
                                ...
                                <form id="main_form" action="{{ route(" vehicle") }}" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" name="current_plate" style="display: none;"
                                            value="{{ isset($vehicle) ? (isset($vehicle->plate_no) ? \App\Http\Controllers\BaseController::enc($vehicle->plate_no) : "") : "" }}"
                                            class="form-control">
                                        <input type="text" name="vvcabinid" style="display: none;"
                                            value="{{ isset($vehicle) ? (isset($vehicle->id) ? \App\Http\Controllers\BaseController::enc($vehicle->id) : "") : "" }}"
                                            class="form-control">
                                        <input type="text" id="new_owner_id" name="new_owner" style="display: none;"
                                            value="" class="form-control">
                                        <input type="text" id="arkhCheckNum" name="arkhCheckNum" style="display: none;"
                                            value="" class="form-control">

                                        <input type="text" id="fingerTotalDescription" name="fingerTotalDescription"
                                            style="display: none;" value="" class="form-control">
                                        <input type="text" id="ntrBookdate" name="ntrBookdate" style="display: none;"
                                            value="" class="form-control">
                                        <input type="text" id="ntrBooknumber" name="ntrBooknumber"
                                            style="display: none;" value="" class="form-control">
                                        <input type="text" id="restoreStatusCheck" name="restoreStatusCheck"
                                            style="display: none;" value="" class="form-control">
                                        <input type="text" id="ntrLastname" name="ntrLastname" style="display: none;"
                                            value="" class="form-control">
                                        <input type="text" id="ntrFirstname" name="ntrFirstname" style="display: none;"
                                            value="" class="form-control">

                                        <input type="text" id="ntrServiceFile" name="ntrServiceFile"
                                            style="display: none;" value="" class="form-control">
                                        <input type="text" id="ntrStateregnumber" name="ntrStateregnumber"
                                            style="display: none;" value="" class="form-control">
                                        <input type="text" id="ntrAddress" name="ntraddress" style="display: none;"
                                            value="" class="form-control">
                                        <input type="text" id="ntrPhone" name="ntrPhone" style="display: none;" value=""
                                            class="form-control">
                                        <input type="number" id="fingerDescription" name="fingerDescription"
                                            style="display: none;" value="0" class="form-control">

                                        <input type="number" id="payDescription" name="payDescription"
                                            style="display: none;" value="0" class="form-control">
                                        <input type="text" id="payDescriptionName" name="payDescriptionName"
                                            style="display: none;" value="" class="form-control">
                                        <input type="number" id="transactionId" name="transactionId"
                                            style="display: none;" value="0" class="form-control">

                                        <input type="number" id="payAmount" name="payAmount" style="display: none;"
                                            value="0" class="form-control">
                                        <input type="text" id="serviceTypeName" name="serviceTypeName"
                                            style="display: none;" value="" class="form-control">

                                        <input type="text" id="checkTorguuli" name="checkTorguuli[]"
                                            style="display: none;" value="" class="form-control">
                                        <input type="text" id="approveCode" name="approveCode" style="display: none;"
                                            value="" class="form-control">
                                        <input type="text" id="signed_data" name="signed_data" style="display: none;"
                                            value="" class="form-control">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="row row-xs align-items-center mg-b-5">
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <label class="form-label mg-b-0">번호판</label>
                                                </div>
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                            ...
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" id="cabin_no_id" name="cabin_no"
                                                        class="form-control cabin_no_id"
                                                        value="{{ isset($vehicle) ? $vehicle->cabin_no : "" }}"
                                                        oninput="translate2LATIN(this.value)" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" id="gaali_inv_id" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->declaration_no : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->vin_no : "" }}" readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->engine_no : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-3 col-md-12 col-sm-12">
                                                    <input id="build_year_id" name="build_year" type="text"
                                                        class="form-control" readonly
                                                        value="{{ isset($vehicle) ? $vehicle->build_year : "" }}">
                                                </div>
                                                <div class="col-lg-3 col-md-12 col-sm-12">
                                                    <input id="build_month_id" name="build_month" type="text"
                                                        class="form-control" readonly
                                                        value="{{ isset($vehicle) ? $vehicle->build_month : "" }}">
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->color_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                            ...
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input id="cert_id" type="text" name="certificate"
                                                        class="form-control" readonly
                                                        value="{{ isset($vehicle) ? $vehicle->certificate_no : "" }}"
                                                        tabindex="1">
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->country_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->purpose_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->vehicle_type_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->mark_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->model_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->eco_class_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->engine_capacity."
                                                        , ".$vehicle->class_name : "" }}" readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->engine_model_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->fuel_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                            ...
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->steering_type_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->wheel_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->length : "" }}" readonly>
                                                </div>
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->height : "" }}" readonly>
                                                </div>
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->width : "" }}" readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                ...
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->own_weight : "" }}"
                                                        readonly>
                                                </div>
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->total_weight : "" }}"
                                                        readonly>
                                                </div>
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->max_load : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->axle_count : "" }}"
                                                        readonly>
                                                </div>
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->seat_count : "" }}"
                                                        readonly>
                                                </div>
                                                <div class="col-lg-2 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->door_count : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->special_name : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input id="page_count_id" type="number" class="form-control"
                                                        readonly name="page_count"
                                                        value="{{ isset($vehicle) ? $vehicle->page_count : "" }}"
                                                        tabindex="2">
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    ...
                                                    <select name="plateColor" id="plateColor"
                                                        class="form-control select2" required>
                                                        @if (isset($vehicle))
                                                        {{-- @if ($vehicle->fuel_type_id==22)
                                                        <option value="3">녹색</option>
                                                        @elseif($vehicle->max_load >= 18000 || $vehicle->length >=12000
                                                        || $vehicle->width >= 2550 || $vehicle->height >= 4000)
                                            ...
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->updated_date : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->archive_no : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                            <div class="row row-xs align-items-center mg-b-5">
                                                ...
                                                <div class="col-lg-6 col-md-12 col-sm-12">
                                                    <input type="text" class="form-control"
                                                        value="{{ isset($vehicle) ? $vehicle->first_archive_no : "" }}"
                                                        readonly>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="form-group mg-b-0">
                                                ...
                                                <textarea style="height: 30px !important;" id="old_number_id"
                                                    class="form-control richtextbox"
                                                    readonly="">{{ isset($vehicle) ? $oldNumbers : "" }}</textarea>
                                            </div>
                                            <div class="form-group mg-b-0">
                                                <label class="form-label">상태 변경</label>
                                                <textarea style="height: 30px !important;" id="lastmod_id"
                                                    class="form-control richtextbox"
                                                    readonly="">{{ isset($vehicle) ? $vehicle->status_name.", ".$vehicle->firstname : "" }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-8 col-md-6 col-sm-12">
                                            <div class="form-servgroup mg-b-0">
                                                <label class="form-label">특이사항</label>
                                                <textarea rows="5" style="height: 85px !important;color: red" readonly
                                                    id="description_id" readonly name="description"
                                                    class="form-control richtextbox">{{ isset($vehicle) ? $vehicle->description : "" }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <hr class="mg-y-10">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table class="table table-bordered table-striped mg-b-10"
...
{{---------------------------Menu-------------------------------}}
                                        ...
                                        @else
                                            ...
                                            @if(session()->get("auth")->userpositionid == 87 && $archive_department_abbr = session()->get("archive")->abbr == "ДК")
                                                @if($Diagnostic != null)
                                                    @if($Diagnostic->dateagain == null || \Carbon\Carbon::parse($Diagnostic->dateagain)->format("Y-m-d") > \Carbon\Carbon::now()->format("Y-m-d"))
                                                        @if((string)strpos($vehicle->archive_no, "SHEDK") == "0" || (string)strpos($vehicle->archive_no, "SHEBUTS") == "0")
                                                ...
                                                @if(\App\Http\Controllers\BaseController::hasMenuShow(17, 2, \App\Http\Controllers\BaseController::enc(session()->get("auth")->userpositionid)) && ((string)strpos($vehicle->archive_no, "SHEDK") == "0" || (string)strpos($vehicle->archive_no, "SHEBUTS") == "0"))
                                                    <div id="menu_REMOVE" class="media">
                                                        <div class="media-icon bg-success"><i class="typcn typcn-minus-outline"></i></div>
        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <label class="ckbox">
                            <input type="checkbox" id="isCheckRestoreArkh" onchange="isCheck(this.id);"><span>아카이브тай сэргээх</span>
                        </label>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <label class="ckbox">
                            <input type="checkbox" id="isCheckRestoreArkhNo" onchange="isCheck(this.id);"><span>아카이브гүй сэргээх</span>
                        </label>
                    </div>
...
<div id="descriptionModal" class="modal">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">특이사항 оруулах</h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <form action="{{ route("description_vehicle") }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <br/>
                            <h5 style="color: red;text-align: center">저장 товч дарахад шууд бүртгэгдэхийг анхаарна уу!</h5>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary">저장</button>
                    ...
                    <div class="row" style="border:0px solid black" >
                        ...
                        <div  style="border:0px solid red;float:left;">
                            <div id="powner" style="position: absolute;top:40px;left:350px;font-size:14px;">
                                <?PHP
$name = isset($owners) ? $owners->first()->last_name . " " . $owners->first()->first_name : "";
...
??
                            ...
                            <div id="paddress" style="position: absolute;top:120px;left:330px;font-size:11px;">
                                <?PHP
$name = isset($owners) ? $owners->first()->address_detail : "";
            ...
            <div class="modal-body">
                <div class="row row-sm mg-b-20">
                    <div class="col-lg-6  mg-t-20 mg-sm-t-0">
                        <div class="card card-dashboard-twentysix card-dark-one readMoreTorguuli" style="background-color: #673ab7; background-image: linear-gradient(to bottom, #673ab7 0%, #673ab7 100%); background-repeat: repeat-x;">
                            <div class="card-header">
                                <h6 class="card-title"><i class="icon ion-md-cash"></i> ТӨЛӨӨГҮЙ ТОРГУУЛЬ</h6>
                            </div>
                    ...
                    <div class="col-lg-6 mg-t-20 mg-lg-t-0">
                        <div class="card card-dashboard-twentysix card-dark-two readMoreTorguuli" style="background-color: #4caf50; background-image: linear-gradient(to bottom, #4caf50 0%, #4caf50 100%); background-repeat: repeat-x;">
                            <div class="card-header">
                                <h6 class="card-title"><i class="icon ion-md-card"></i> ҮЗЛЭГ, ОНОШЛОГОО</h6>
                            </div>
                            <div class="card-body" style="    height: 60px;">
                                <div class="pd-x-15">
                                    @if(isset($Diagnostic))
                ...
                <table class="table table-bordered" id="torguuliTable" style="display: none;">
                    ...
                    <tr>
                        ...
                        <th>
                            <div style="text-align: center;">Дүн</div>
                        </th>
                        <th>
        ...
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                ...
                <div class="col-lg-9  mg-t-20 mg-sm-t-0">
                    <div class="card card-dashboard-twentysix card-dark-one readMoreTorguuli" style=" background-color: #673ab7; background-image: linear-gradient(to bottom, #673ab7 0%, #673ab7 100%); background-repeat: repeat-x;">
                        <div class="card-header">
                            <h6 class="card-title"><i class="icon ion-md-cash"></i> ТӨЛӨӨГҮЙ ЗАМЫН ТӨЛБӨР</h6>
                        </div>
                        <div class="card-body" style=" height: 60px; ">
                            <div class="pd-x-15">
...
<div id="fingerModal" class="modal">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="width: 50%">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">ОДООГИЙН ӨМЧЛӨГЧИЙГ БАТАЛГААЖУУЛАХ</h6>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="ckbox">
                            <input type="checkbox" id="notCheckFinger" onchange="isCheck(this.id);"><span>Уншуулаагүй</span>
                        </label>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="ckbox">
                            <input type="checkbox" id="checkFinger" onchange="isCheck(this.id);"><span>Уншуулсан</span>
                        </label>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                      
                        <label class="ckbox">
                            <input type="checkbox" id="ntrCheck" onchange="isCheck(this.id);"><span>Нотриат</span>
                        </label>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label class="ckbox">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12">
                            ...
                            color: #fff;" class="btn btn-info btn-block btnnopadding" onclick="ntrlogin1();">확인</button>
                             <button type="button" style="
                             color: #fff;" class="btn btn-warning btn-block btnnopadding" onclick="threeConnect();">Хуруу шалгах</button>
                        </div>
...
<div id="transaction" class="modal">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="width: 70%">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">ТӨЛБӨРИЙН МЭДЭЭЛЭЛ БАТАЛГААЖУУЛАХ</h6>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-sm-12">
                        <label class="ckbox">
                            <input type="checkbox" id="geregePay" onchange="isCheck(this.id);"><span>Гэрэгэ</span>
                        </label>
                    </div>
                    <div class="col-lg-2 col-md-6 col-sm-12">
                        <label class="ckbox">
...
<div id="fingerOtherModal" class="modal">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="width: 40%">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">ХУРУУНЫ ХЭЭНИЙ МЭДЭЭЛЭЛ БАТАЛГААЖУУЛАХ</h6>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-8">
...
<div id="eRequestCheckModal" class="modal">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document" style="width: 60%">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">ЦАХИМ ХҮСЭЛ ЖАГСААЛТ</h6>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
...
<input type="hidden" id="userPkId" value="<?php if (isset($vehicle))
    ...
    echo $vehicle->purpose_id; ?>" />
                                                        ...
                                                        <script
                                                            src="{{ asset('lib/jquery-ui/ui/widgets/datepicker.js') }}"></script>
                                                        <script
                                                            src="{{ asset('lib/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
                                                        ...
                                                        <script
                                                            src="{{ asset('lib/select2/js/select2.min.js') }}"></script>
                                                        <script
                                                            src="{{ asset('lib/jquery.flot/jquery.flot.js') }}"></script>
                                                        <script
                                                            src="{{ asset('lib/jquery.flot/jquery.flot.categories.js') }}"></script>
                                                        <script
                                                            src="{{ asset('lib/jquery.flot/jquery.flot.resize.js') }}"></script>
                                                        <script
                                                            src="{{ asset('lib/flot.curvedlines/curvedLines.js') }}"></script>
                                                        <script
                                                            src="{{ asset('lib/jQuery-Mask-Plugin-master/src/jquery.mask.js') }}"></script>
                                                        <script src="{{ asset('js/vrs.js') }}"></script>
                                                        <script src="{{ asset('js/avtoteever.js') }}"></script>
                                                        <script
                                                            src="{{ asset('lib/dev-extreme/js/dx.all.js')}}"></script>
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    success: function (data) {
                                                                        try {
                                                                            ...
                                                                            //         var html =
                                                                            //             '<tr>' +
                                                                            //             '<td style="width:35%;font-weight: bold;">결제ийн үлдэгдэл </td>' +
                                                                                ...
                                                                                $.each(data, function (key, value) {
                                                                                    ...
                                                                                    if (Array.isArray(value.response.listData) == false) {
                                                                                        ...
                                                                                        if (value.response.listData['paid'] == false) {
                                                                                            var checkTorguuli = value.response.listData['passDate'] + "-ний 일 торгуулсан " + value.response.listData["amount"].toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,');
                                                                                        ...
                                                                                        value.response.listData.forEach(function (item) {
                                                                                            ...
                                                                                            //  if(Date.parse(item.passDate) >= Date.parse('@if(isset($owners)){{ $owners->first()->start_date }}@endif') && item.paid ==false) {
                                                                                            var status = "납부";
                                                                                    ...
                                                                                    try {
                                                                                        value.response.listData.forEach(function (item) {
                                                                                            ...
                                                                                            if ((parseFloat(item["airPollAmount"]) + parseFloat(item["taxAmount"]) + parseFloat(item["trafficAmount"])) == (parseFloat(item["paidAirPollAmount"]) + parseFloat(item["paidTaxAmount"]) + parseFloat(item["paidTrafficAmount"])))
                                                                                                var status = "납부";
                                                                                            var description = "<b>АТБӨЯХ세금</b>: " + item["paidTaxAmount"] + "₮<br><b>АБ결제:</b> " + item["paidAirPollAmount"] + "₮<br><b>АЗА결제:</b> " + item["paidTrafficAmount"] + "₮";
                ...
                if (name == "RESTRICT") {
                                                                ...
                                                                if (name == "NEW") {
                                                                    var userCheck = '{{session()->get("archive")}}';
                                                                        ...
                                                                        success: function (data) {
                                                                            ...
                                                                            if (data.status == "error") {
                                                                                ...
                                                                                for (var i = 0; i < data.length; i++) {
                                                                                    ...
                                                                                    selOpts += "<option  value='" + id + ',' + amount + "'>" + "<label>금액:" + amount + "₮_</label>" + "<strong>검정ицсан данс:" + related_account + "_</strong>" + "<strong>일자:" + transaction_date + "</strong>" + "</option>";
